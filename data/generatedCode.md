...
```
//go:generate protoc -I=proto -I=$GOPATH/src -I=$GOPATH/src/github.com/numbatx/protobuf/protobuf  --gogoslick_out=. message.proto
```
...
Check [gogo protobuf geting started](https://github.com/numbatx/protobuf#getting-started) for initial setup.
