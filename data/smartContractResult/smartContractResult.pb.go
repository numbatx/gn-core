...
import (
	...
	github_com_numbatx_gn_vm_common_vmcommon "github.com/numbatx/gn-vm-common"
	io "io"
	math "math"
	math_big "math/big"
	math_bits "math/bits"
...
type SmartContractResult struct {
	...
	Value          *math_big.Int                                     `protobuf:"bytes,2,opt,name=Value,proto3,casttypewith=math/big.Int;github.com/numbatx/gn-core/data.BigIntCaster" json:"value"`
	...
	RelayedValue   *math_big.Int                                     `protobuf:"bytes,6,opt,name=RelayedValue,proto3,casttypewith=math/big.Int;github.com/numbatx/gn-core/data.BigIntCaster" json:"relayedValue"`
	...
	CallType       github_com_numbatx_gn_vm_common_vmcommon.CallType `protobuf:"varint,13,opt,name=CallType,proto3,casttype=github.com/numbatx/gn-vm-common/vmcommon.CallType" json:"callType"`
...
func (m *SmartContractResult) GetCallType() github_com_numbatx_gn_vm_common_vmcommon.CallType {
	if m != nil {
		return m.CallType
	}
	return 0
...
var fileDescriptor_edc1605de0d3d805 = []byte{
	...
	,
}
	...
	for iNdEx < l {
		...
		case 13:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.CallType |= github_com_numbatx_gn_vm_common_vmcommon.CallType(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
